...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        help="Image backbone (overridden by the policy config)",
    )
    ...
    parser.add_argument('--ckpt_dir', default ='/home/ub/act/checkpoint1', action='store', type=str, help='ckpt_dir')
    parser.add_argument('--policy_class', action='store', type=str, help='policy_class, capitalize')
    parser.add_argument('--task_name', default= 'Pick_Place_Square', action='store', type=str, help='task_name')
